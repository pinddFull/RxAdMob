...
public extension Reactive where Base: GADUnifiedNativeAd {
    ...
    var extraAssets: Observable<[String : Any]?> {
    ...
    var delegate: DelegateProxy<GADUnifiedNativeAd, GADUnifiedNativeAdDelegate> {
    ...
    var nativeAdDidRecordImpression: ControlEvent<GADUnifiedNativeAd> {
    ...
    var nativeAdDidRecordClick: ControlEvent<GADUnifiedNativeAd> {
    ...
    var nativeAdWillPresentScreen: ControlEvent<GADUnifiedNativeAd> {
    ...
    var nativeAdWillDismissScreen: ControlEvent<GADUnifiedNativeAd> {
    ...
    var nativeAdDidDismissScreen: ControlEvent<GADUnifiedNativeAd> {
    ...
    var nativeAdWillLeaveApplication: ControlEvent<GADUnifiedNativeAd> {
